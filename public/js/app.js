...
window.FilePond = filepond__WEBPACK_IMPORTED_MODULE_2__; // Navigation scroll


new (smooth_scroll__WEBPACK_IMPORTED_MODULE_3___default())('a[href*="#"]');
...
prismjs__WEBPACK_IMPORTED_MODULE_4___default().plugins.NormalizeWhitespace.setDefaults({
  'remove-trailing': true,
  'remove-indent': true,
  'left-trim': true,
  'right-trim': true
});
prismjs__WEBPACK_IMPORTED_MODULE_4___default().highlightAll();
