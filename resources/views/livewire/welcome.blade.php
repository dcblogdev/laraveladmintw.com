...
<main class="max-w-screen-xl px-4 mx-auto mb-10 sm:mt-12 sm:px-6 md:mt-15">
    <div class="text-center">
        ...
        <p class="mt-5">
            <a href="{{ url('docs') }}" class="px-4 py-4 text-xl text-gray-100 rounded-md bg-primary">Get Started</a>
        </p>
...
<div class="px-4 mx-auto mb-10 max-w-7xl">
     <picture>
        ...
        <img class="rounded-lg" src="{{ url('images/admin-tw-settings.png') }}" alt="Laravel Admin Theme - Laravel AdminTW">
    </picture>
</div>

<div class="bg-gray-200 dark:bg-gray-700">
    <div class="px-8 py-4 mx-auto max-w-7xl">
        <p class="mt-4 text-lg text-gray-500 dark:text-gray-100">Laravel AdminTW is minimal Livewire theme styled with TailwindCSS.</p>
        <p class="mt-4 text-lg text-gray-500 dark:text-gray-100">Laravel AdminTW supports both light and dark mode based on the users OS.</p>
        <p class="mt-4 text-lg text-gray-500 dark:text-gray-100">Provided are blade and Laravel Livewire components for common layout / UI elements and a complete test suite (Pest PHP).</p>
    </div>
</div>
