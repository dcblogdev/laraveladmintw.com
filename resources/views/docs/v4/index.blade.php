<x-guest-layout>
    @section('title', 'Laravel Starter Kit / Laravel Admin Theme')
    @include('layouts.v4.header')
        ...
        <div class="text-center">
            ...
            <a href="{{ url('/') }}">
                <h2 class="mt-10 text-4xl font-extrabold leading-10 tracking-tight text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
                    <span class="dark:text-gray-100">Laravel</span>
            ...
            <p class="mt-5">
                <a href="{{ url('v4/docs') }}" class="px-4 py-4 text-xl text-gray-100 rounded-md bg-primary">Get Started</a>
